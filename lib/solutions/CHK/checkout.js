...
module.exports = function (skus) {
    ...
    let combinedOffer = amount['S'] + amount['T'] + amount['X'] + amount['Y'] + amount['Z'];
    let bundles = parseInt(combinedOffer/3);
